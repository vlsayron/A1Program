...
namespace MvcMusicStore.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private readonly CounterHelper<Counters> _counterHelperLogIn;
        private readonly CounterHelper<Counters> _counterHelperLogOff;

        public AccountController(ILogger logger)
            : this(new UserManager<ApplicationUser>(new UserStore<ApplicationUser>(new ApplicationDbContext())))
        {
            _logger = logger;
            _counterHelperLogIn = PerformanceHelper.CreateCounterHelper<Counters>("Successful Log in counter instance");
            _counterHelperLogOff = PerformanceHelper.CreateCounterHelper<Counters>("Successful Log off counter instance");
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    ...
                    _counterHelperLogIn.Increment(Counters.SuccessLogIn);
                    _logger.Info($"User {user.UserName} logged in successfully");
                    return RedirectToLocal(returnUrl);
                }

                _logger.Info($"User {model.UserName} is not logged in( Invalid username or password)");
        ...
        public ActionResult LogOff()
        {
            ...
            _counterHelperLogOff.Increment(Counters.SuccessLogOff);
            return RedirectToAction("Index", "Home");
        }
